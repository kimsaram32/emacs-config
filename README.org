...
#+begin_src elisp
(setq me:org-agenda-files-basic (list me:note-root-directory
				      (expand-file-name "buffers/" me:note-root-directory)
				      (expand-file-name "projects/" me:note-root-directory)))
(setq org-agenda-files (append
			me:org-agenda-files-basic
			(list me:note-zk-directory)))
#+end_src
...
(setq org-agenda-custom-commands
      '(("d" "Daily agenda" agenda "TODO"
	 ((org-agenda-files me:org-agenda-files-basic)
	  (org-agenda-span 'day)))))
#+end_src
