...
#+begin_src elisp
  ...
  (keymap-set c-mode-map "C-M-x" 'me:c-previous-defun-body)
  (keymap-set c-mode-map "C-M-y" 'me:c-next-defun-body)
#+end_src
** Yaml
#+begin_src elisp
  (require 'yaml-mode)
...
#+end_src
*** Custom daily agenda (org-super-agenda)
#+begin_src elisp
